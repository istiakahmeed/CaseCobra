            ...
            <div className="bg-gray-50 p-6 sm:rounded-lg sm:p-8">
              <div className="flow-root text-sm">
                <div className="flex items-center justify-between py-1 mt-2">
                  ...
                  <p className="font-medium text-gray-600">{formatPrice(BASE_PRICE / 100)}</p>
                </div>

                {finish === "textured" && (
                  <div className="flex items-center justify-between py-1 mt-2">
                    <p className="text-gray-600">Textured finish</p>
                    <p className="font-medium text-gray-600">{formatPrice(PRODUCT_PRICES.finish.textured / 100)}</p>
                  </div>
                )}
                ...
                {material === "polycarbonate" && (
                  <div className="flex items-center justify-between py-1 mt-2">
                    ...
                    <p className="font-medium text-gray-600">{formatPrice(PRODUCT_PRICES.material.polycarbonate / 100)}</p>
                  </div>
                )}
